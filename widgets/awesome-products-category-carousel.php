<?php
/**
 * Awesome Products Category Carousel Widget.
 *
 * Elementor widget that inserts a Products Category Carousel into the page
 *
 * @since 1.0.0
 */
namespace Elementor;
class Widget_Awesome_Products_Category_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'awesome-products-category-carousel';
	}
