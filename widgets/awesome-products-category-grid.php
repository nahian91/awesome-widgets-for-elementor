<?php
/**
 * Awesome Products Category Grid Widget.
 *
 * Elementor widget that inserts a products category grid into the page
 *
 * @since 1.0.0
 */
namespace Elementor;
class Widget_Awesome_Products_Category_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'awesome-products-category-grid';
	}
	...
	public function get_title() {
		return esc_html__( 'Products Category Grid', 'awesome-widgets-elementor' );
	}
