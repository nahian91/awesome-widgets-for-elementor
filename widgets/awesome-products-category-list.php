<?php
/**
 * Awesome Products Category List Widget.
 *
 * Elementor widget that inserts a products category list into the page
 *
 * @since 1.0.0
 */
namespace Elementor;
class Widget_Awesome_Products_Category_List extends Widget_Base {
	...
	public function get_name() {
		return 'awesome-products-category-list';
	}
	...
	public function get_title() {
		return esc_html__( 'Products Category List', 'awesome-widgets-elementor' );
	}
